...
const DEFAULTS = [
  {
    ...
    bodyEn:
      "<p>I'm Andres, from Flash-it (ValuConnect Solutions). Your request came through and I review every one personally.</p>" +
      ...
      '<p>Talk soon!<br/>— Andres, Flash-it</p>',
    bodyEs:
      '<p>Soy Andres, de Flash-it (ValuConnect Solutions). Recibí tu solicitud y la reviso personalmente.</p>' +
      ...
      '<p>¡Hablamos pronto!<br/>— Andres, Flash-it</p>',
  },
  {
    ...
    bodyEs:
      ...
      '<p>Con cariño,<br/>— Andres, Flash-it</p>',
  },
  {
    key: 'promo-offer',
  ...
  },
  {
    ...
    bodyEn:
      ...
      '<p>Thank you so much,<br/>— Andres, Flash-it</p>',
    bodyEs:
      ...
      '<p>¡Muchas gracias!<br/>— Andres, Flash-it</p>',
  },
];
...
/** Wrap inner email HTML in the Flash-it brand shell. */
function wrapEmail(innerHtml) {
  return `<!DOCTYPE html><html><body style="margin:0;padding:0;background:#0d0d1a;font-family:system-ui,sans-serif;color:#f1f5f9;">
    <div style="max-width:560px;margin:0 auto;padding:2rem 1rem;">
      ...
      <div style="font-size:1rem;line-height:1.6;color:#e2e8f0;text-align:center;">${innerHtml}</div>
